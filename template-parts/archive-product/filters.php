  ...
  <div class="refinement-bar__body gutter--small-only-normal fixit-element" data-fixit-trigger='{"enabled": "small-up", "respondToParent": true, "containedInParent": true, "offset": ".header", "useOffsetOnTarget": true}'>
    <div class="refinements body-type--deci">
      ...
      if (!isset($_GET['collection'])) {
        $collections = Product::get_available_collections($category);
      ?>
        <div class="refinement refinement-collection " data-refinement-type="collection" tabindex="-1">
          ...
          <div id="refinement-collection" class="refinement__content ">
            <ol class="refinement__collection list--reset">
              ...
              ?>
              <li class="refinement__boolean-item <?= $count >= 5 ? 'hidden' : '' ?>" <?= $count >= 5 ? 'data-refinement-hide' : '' ?>>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=<?= $category ?>&prefn1=collection&prefv1=<?= $name ?>&prefn2=sapIsVisibleWeb&prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-<?= $name ?>" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    <?= $name ?>
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  ">
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Cartier%20Destin%c3%a9e&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Cartier Destin&eacute;e" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Cartier%20D%27Amour&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Cartier D'Amour" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    Cartier D'Amour
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Diamants%20L%c3%a9gers&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Diamants L&eacute;gers" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Juste%20Un%20Clou&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Juste Un Clou" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    Juste Un Clou
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=OFF%20RENAISSANCE&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-OFF RENAISSANCE" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    OFF RENAISSANCE
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Trinity&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Trinity" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    Trinity
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Tank%20Fran%c3%a7aise&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Tank Fran&ccedil;aise" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=TRINITY%20RUBAN&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-TRINITY RUBAN" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    TRINITY RUBAN
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=C%20de%20Cartier&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-C de Cartier" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    C de Cartier
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=OBJETS%20HAUTE%20JOAILLERIE&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-OBJETS HAUTE JOAILLERIE" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Geometry%20%26%20Contrast&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Geometry &amp; Contrast" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    Geometry &amp; Contrast
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=COLLECTION%20DIAMANT&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-COLLECTION DIAMANT" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    COLLECTION DIAMANT
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Agrafe&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Agrafe" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    Agrafe
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=1895&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-1895" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    1895
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Ballerine&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Ballerine" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    Ballerine
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Essential%20Lines&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Essential Lines" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    Essential Lines
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Logo&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Logo" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    Logo
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=Paris%20Nouvelle%20Vague&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-Paris Nouvelle Vague" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=LOVE&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-LOVE" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    LOVE
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=CHAINS%20AND%20LINKS&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-CHAINS AND LINKS" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    CHAINS AND LINKS
                  </span>
                  <span class="sr-only selected-assistive-text">
              ...
              <li class="refinement__boolean-item  hidden" data-refinement-hide>
                <a href="wp-json/siellest/Search-ShowAjax?cgid=Jewelry_AllCollections&amp;prefn1=collection&amp;prefv1=%5bSUR%5dNATUREL&amp;prefn2=sapIsVisibleWeb&amp;prefv2=true" class="form-check-label  " data-refinement-action="boolean" data-refinement-id="boolean-[SUR]NATUREL" data-window-scroll='{"target": ".search-results", "offset": ".header"}'>
                  <span class="body-type--centi link--underline-hover" aria-hidden="true">
                    [SUR]NATUREL
                  </span>
                  <span class="sr-only selected-assistive-text">
