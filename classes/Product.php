...
class Product
{
  ...
  public static function render_product($product, $add_to_bag=false, $is_grid=true)
  {
    $id       = $product->id;
    ...
    $img1            = wp_get_attachment_image_src($product->get_image_id(), 'medium')[0];
    $gallery_images  = $product->get_gallery_image_ids();
    if (sizeof($gallery_images) > 0) {
      $img2 = wp_get_attachment_image_src($gallery_images[0], 'medium')[0];
    }
    ...
    include get_template_directory() . '/template-parts/product-tile.php';
  }
